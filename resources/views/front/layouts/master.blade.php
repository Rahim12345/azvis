                ...
                <div class="header__main__holder__navigation">
                    ...
                    <ul class="header__main__holder__navigation__list" role="navigation">
                        <li class="header__main__holder__navigation__list__item">
                            <a href="{{ route('front.home') }}" class="header__main__holder__navigation__list__item__link active">Ana Səhifə</a>
                        </li>
                        <li class="header__main__holder__navigation__list__item">
                            <a href="about.html" class="header__main__holder__navigation__list__item__link">Haqqımızda</a>
                        </li>
                        <li class="header__main__holder__navigation__list__item">
                            <a href="emax.html" class="header__main__holder__navigation__list__item__link">Xidmətlərimiz</a>
                        </li>
                        <li class="header__main__holder__navigation__list__item">
                            <a href="packages.html" class="header__main__holder__navigation__list__item__link">Paketlərimiz</a>
                        </li>
                        <li class="header__main__holder__navigation__list__item">
                        ...
                        <li class="header__main__holder__navigation__list__item">
                            <a href="contact.html" class="header__main__holder__navigation__list__item__link ">Əlaqə</a>
                        </li>
                    </ul>
...
<header class="vs-menu-wrapper position-re overfollow-hidden">
    <div class="vs-menu-area">
        ...
        <ul class="menu-items">
            <li class="nav-item">
                <a class="nav-link vs-mobile-menu" href="{{ route('front.home') }}">Ana Səhifə</a>
            </li>
            <li class="nav-item">
                <a class="nav-link vs-mobile-menu" href="about.html">Haqqımızda</a>
            </li>
            <li class="nav-item">
                <a class="nav-link vs-mobile-menu" href="emax.html" role="button" aria-haspopup="true"
                   aria-expanded="false">Xidmətlərimiz</a>
            </li>
            <li class="nav-item">
                <a class="nav-link vs-mobile-menu active" href="packages.html">Paketlərimiz</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link vs-mobile-menu active" href="contact.html">Əlaqə</a>
            </li>
        </ul>
            ...
            <div class="row">
                <div class="info col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="box col-3 col-md-12 col-sm-12">
                        <h2>Stomatologiyada bələdçiniz</h2>
                        <p>Xoşbəxt və sağlam yaşamaq hər birimiz haqqıdır.</p>
                        <div class="popup">
                            <a href="javascript:(0)" data-effect="mfp-zoom-in" class="step1 btn">ONLAYN GEYDİYYAT</a>
                        </div>
                    </div>

                    <div class="box col-3 col-md-12 col-sm-12">
                        <h2>ASAN MENYU</h3>
                            <a href="javascript:(0)">Haqqımızda</a>
                            <a href="javascript:(0)">Xidmətlər</a>
                            <a href="javascript:(0)">Paketlər</a>
                            <a href="javascript:(0)">Bloq</a>
                            <a href="javascript:(0)">Ən çox verilən suallar</a>
                    </div>

                    <div class="box col-3 col-md-12 col-sm-12">
                        <h2>FƏALİYYƏTİMİZ</h2>
                        <p>Beynəlxalq standartlara uyğun tibbi xidmət sistemini və təfəkkürünü formalaşdırmaq və həyata
                            keçirməkdən
                            ibarətdir.</p>
                    </div>
                ...
                <div class="location col-lg-6 col-md-12 col-sm-12">
                    <div class="block">
                        ...
                        <div class="button">
                            <a href="javascript:(0)" class="step1 btn">Xəritədə bax<i class="fa-solid fa-circle-play"></i></a>
                        </div>
                    </div>
                </div>
            </div>
